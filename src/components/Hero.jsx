      ...
      <AppScreen.Body>
        <div className="p-4">
          <div className="flex gap-2">
            ...
            <div className="text-sm text-gray-900">$Golf</div>
          ...
          <div className="mt-3 border-t border-gray-200 pt-5">
            ...
            <div className="mt-3 divide-y divide-gray-100 text-sm">
              <div className="flex justify-between py-1">
                <div className="text-gray-500">90 balls</div>
                <div className="font-medium text-gray-900">20.00</div>
              </div>
              <div className="flex justify-between py-1">
                <div className="text-gray-500">100 balls</div>
                <div className="font-medium text-gray-900">25.00</div>
              </div>
              <div className="flex justify-between py-1">
                <div className="text-gray-500">1000 balls</div>
                <div className="font-medium text-gray-900">60.00</div>
              </div>
            </div>
          </div>
        </div>
